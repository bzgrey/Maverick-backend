...
content_id: 5ab65b3afced152a23b8242d75e3ecff0f213041d34848bdce5d6ab19caf85ab
---
...
**Important:** `Requesting.respond` takes a *flat* list of return **parameters**, meaning that the values provided to it should not be nested objects directly in the synchronization specification itself. For example, consider the following:
