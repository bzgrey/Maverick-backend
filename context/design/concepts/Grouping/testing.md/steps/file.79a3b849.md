---
timestamp: 'Sun Nov 30 2025 11:37:35 GMT-0500 (Eastern Standard Time)'
parent: '[[../20251130_113735.3f03e56e.md]]'
content_id: 79a3b84929b535f9d0602d3816ad49d40672c3ab31fdfe5a7e1fe23d9aa63c1a
---
...
Deno.test("Grouping Concept Queries", async (t) => {
  ...
  await t.step(
    "_getRequests: returns users with pending requests",
    async () => {
  ...
  await t.step("_getGroupByName: finds group by name", async () => {
    const [{ group: foundGroup }] = await grouping._getGroupByName({
      name: "Query Test Group",
    });
